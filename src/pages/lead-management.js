...
function LeadManagement({ userDetails }) {
  ...
  function getUnattendedLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=unattended').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getRetentionLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=retention').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getColdLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=cold').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getWarmLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=warm').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getHotLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=hot').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getClosedLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=closed').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getConvertedLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=converted').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
  ...
  function getFollowupLead() {
    axios.get(process.env.REACT_APP_ADMIN_URL + 'tpdLeads.php?username=' + userDetails.username + '&city=' + userDetails.city + '&type=followup').then(function (response) {
      var data = response.data;
      if (data.statusCode === 200)
