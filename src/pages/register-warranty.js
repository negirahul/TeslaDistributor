...
function RegisterWarranty({ userDetails }) {
  ...
  const warrantySubmit = (event) => {
    ...
    axios.post( process.env.REACT_APP_ADMIN_URL + 'warrantyAddByDistributor.php', {inputs, billCopy, warrantyCard, userDetails}).then(function(response){
      ...
      <div className="container">
        ...
        <div className="">
          <div className="my-3 position-relative">
            <input type="text" name="search" onInput={inputChange} className="form-control" placeholder="Search Customer No. / Serial No. / Model No."/>
              ...
              <div>
                ...
                {serialNoVerify ? 
                  <>
                    ...
                    <div className="mb-3">
                      <label htmlFor="bill_copy" className="form-label">Attach Bill Copy Image</label>
                    ...
                    <div className="mb-3">
                      <label htmlFor="warranty_card" className="form-label">Attach Warranty Card Image</label>
